...
/*This code is for reading and writing to files for the 2025-2026 COMP328 CA*/
...
/*Gets the temperatures from the file. Returns as an array of doubles. Ignores the first numOfValues*/
double *read_array(char *filename, int numOfValues) {
    FILE *file = fopen(filename,"r");
    int i;
